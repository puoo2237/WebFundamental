...
<%
	...
	try{
		multi = new MultipartRequest(
				...
				"utf-8", // 인코딩 타입
				// 파일 이름이 중복되었을 때 파일명 끝에 1, 2, 3순으로 파일 이름을 ㅂ변경해주는 클래스
...
name: <%=name%><br>
<img src = "/upload/file/<%=year%>/<%=month%>/<%=fileName%>">
File System Name : <a href = "/upload/file/<%=year%>/<%=month%>/<%=fileName%>"></a>(<%=fileSize %>kb)<br>
